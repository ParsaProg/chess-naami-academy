...
const images = [
  ...
  'https://chessnaami.ir/_next/image?url=%2F_next%2Fstatic%2Fmedia%2Fchess-academy.abafe389.png&w=750&q=75',
...
export default function SwiperSlideShow() {
  ...
  return (
    <div className="overflow-hidden swiper-container" style={{ width: '90%', maxWidth: '850px' }}>
      <Swiper
