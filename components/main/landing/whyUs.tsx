...
interface WhyUsInterface {
  whyUsComponentRef: React.RefObject<HTMLDivElement | null>;
}

export default function WhyUs({ whyUsComponentRef }: WhyUsInterface) {
  return (
    <div
      ref={whyUsComponentRef}
      className="links-containers w-[95%] max-w-[1400px] mt-[40px] md:mt-[60px] lg:mt-[80px] mx-auto flex flex-col items-center px-4 sm:px-6 lg:px-8"
    >
      {/* Heading */}
      ...
      <div className="mt-[30px] sm:mt-[50px] grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6 lg:gap-[30px] w-full">
        ...
        <div className="bg-white rounded-lg p-4 sm:p-5 container-counter flex flex-col items-start h-full">
          ...
          <p className="text-slate-500 text-sm sm:text-base font-[500] mt-2 sm:mt-3">
            امکان شرکت در جلسات تمرین گروهی و بازی با سایر دانش‌آموزان برای
