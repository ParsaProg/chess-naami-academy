export default function ReadyToStartLearning() {
  return (
    <div className="py-12 md:py-[50px] text-white w-full mt-10 md:mt-[60px] lg:mt-[80px] mx-auto flex flex-col items-center px-4 sm:px-6 lg:px-8 bg-[#F49E0B]">
      ...
      <button className="bg-white text-[#F49E0B] rounded-lg p-3 font-bold mt-5 shadow-amber-600 shadow-2xl cursor-pointer">ثبت‌نام در دوره‌ها</button>
    </div>
  );
}
