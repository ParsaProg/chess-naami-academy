...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    images: [
      {
        url: `${process.env.NEXT_PUBLIC_SITE_URL}/api/og?title=${encodeURIComponent('مقالات تخصصی')}&description=${encodeURIComponent('مجموعه کامل مقالات آموزشی و تخصصی')}&type=list`,
        width: 1200,
        height: 630,
        alt: 'مقالات تخصصی',
      },
  ...
  twitter: {
    ...
    description: 'بهترین مقالات آموزشی و تخصصی در زمینه برنامه نویسی و تکنولوژی',
    images: [
      `${process.env.NEXT_PUBLIC_SITE_URL}/api/og?title=${encodeURIComponent('مقالات تخصصی')}&description=${encodeURIComponent('مجموعه کامل مقالات آموزشی و تخصصی')}&type=list`,
    ],
  },
}
