  ...
  return (
    <div className="flex flex-col items-start w-[90%] mx-auto">
      ...
      <div className="items-start mt-8 w-full rounded-lg shadow-xl border-[1px] border-slate-300 p-[20px]">
        <p className="text-justify text-lg leading-[40px]">
          مقدمه: چرا شطرنج برای کودکان اهمیت دارد؟ شطرنج فقط یک بازی نیست؛ یک
          ابزار قدرتمند برای رشد ذهنی، تقویت تمرکز و تصمیم‌گیری در کودکان است.
          بسیاری از والدین غرب تهران از جمله ساکنان مرزداران، جنت‌آباد، شهران،
          باغ فیض، سعادت‌آباد، صادقیه و مخبری به دنبال کلاس شطرنج مناسب برای
          فرزندانشان هستند. اما چگونه یک آموزشگاه معتبر و تخصصی را انتخاب کنیم؟
          🧠 مزایای شطرنج برای کودکان چیست؟ تقویت تمرکز و دقت بالا افزایش هوش
          منطقی و قدرت حل مسئله افزایش اعتماد به‌نفس در تصمیم‌گیری تقویت صبر و
          برنامه‌ریزی آشنایی با رقابت سالم 🎓 چرا کلاس‌های شطرنج از سنین پایین
          توصیه می‌شوند؟ تحقیقات نشان داده که کودکانی که از ۵ تا ۷ سالگی وارد
          کلاس شطرنج می‌شوند، در دروس مدرسه نیز عملکرد بهتری دارند. شطرنج با
          فعال‌سازی هر دو نیمکره مغز، درک ریاضی، حافظه تصویری و حتی مهارت‌های
          اجتماعی را افزایش می‌دهد. 🏫 کلاس شطرنج حضوری یا آنلاین؟ مزایا و
          تفاوت‌ها نوع کلاس مزایا حضوری تعامل با مربی، بازی‌های فیزیکی، تمرکز
          بالا آنلاین انعطاف زمانی، دسترسی راحت از هر نقطه، بدون نیاز به
          رفت‌وآمد در آموزشگاه شطرنج ما، هر دو مدل را با کیفیت بالا ارائه
          می‌دهیم. والدین می‌توانند بسته به شرایط خانواده، کلاس مناسب را انتخاب
          کنند. ⭐ چرا آموزشگاه ما یکی از بهترین‌ها در غرب تهران است؟ ما با
          تجربه بالا در آموزش شطرنج کودکان، یکی از تخصصی‌ترین مراکز آموزش شطرنج
          در مناطق زیر هستیم: کلاس شطرنج کودکان در مرزداران آموزش شطرنج جنت‌آباد
          (مرکزی، جنوبی و شمالی) کلاس شطرنج سعادت‌آباد، شهران، باغ فیض، صادقیه،
          مخبری کلاس آنلاین شطرنج برای کودکان سراسر تهران 💼 امکانات ویژه
          آموزشگاه: سالن تمرین رایگان برگزاری مسابقات حضوری و آنلاین رایگان
          اعزام شاگردان به مسابقات فدراسیون، استانی و کشوری آموزش توسط مربیان
          فدراسیونی مجرب با تجربه‌ی کار تخصصی با کودکان کلاس‌های خصوصی، گروهی و
          آنلاین برای سنین مختلف 💸 هزینه کلاس‌های شطرنج در تهران چقدر است؟
          هزینه کلاس‌های ما بسیار مقرون‌به‌صرفه و مطابق با نرخ مصوب فدراسیون
          است. کلاس‌ها به صورت: خصوصی (حضوری/آنلاین) گروهی (با ظرفیت محدود) و
          آزمون‌محور (برای شرکت در مسابقات رسمی) برگزار می‌شود. برای اطلاع دقیق
          از هزینه‌ها با ما تماس بگیرید. 📞 چگونه ثبت‌نام کنیم؟ برای ثبت‌نام در
          کلاس‌های شطرنج حضوری یا آنلاین در مناطق مرزداران، جنت‌آباد، شهران،
          باغ‌فیض، سعادت‌آباد و صادقیه کافیست با ما تماس بگیرید یا فرم ثبت‌نام
          آنلاین را در سایت پر کنید. ✨ نتیجه‌گیری: شطرنج یک سرمایه‌گذاری
          بلندمدت برای ذهن کودک شماست. اگر به دنبال بهترین آموزشگاه شطرنج کودکان
          در غرب تهران هستید، ما با امکانات حرفه‌ای، مربیان متخصص، و مسیر پیشرفت
          واقعی برای فرزندتان آماده‌ایم.
        </p>
