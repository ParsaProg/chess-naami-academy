...
export default function VideoForm() {
  ...
  return (
    <div className="bg-white p-6 rounded-lg shadow-md">
      <h2 className="text-xl font-bold mb-6 text-gray-800">افزودن ویدیو جدید</h2>
      ...
      <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
        ...
        <div>
          ...
          <input
            ...
            className={`w-full px-3 py-2 border rounded-md ${errors.views ? 'border-red-500' : 'border-gray-300'}`}
            defaultValue="0"
          />
          {errors.views && (
        ...
        <div>
          ...
          <input
            id="publisher"
            type="text"
            {...register('publisher', { required: 'نام منتشرکننده الزامی است' })}
            className={`w-full px-3 py-2 border rounded-md ${errors.publisher ? 'border-red-500' : 'border-gray-300'}`}
          />
          {errors.publisher && (
        ...
        <div>
          ...
          <input
            ...
            className={`w-full px-3 py-2 border rounded-md ${errors.videoLink ? 'border-red-500' : 'border-gray-300'}`}
          />
          {errors.videoLink && (
